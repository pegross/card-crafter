...
func _tick_wounds(mins: int) -> void:
	...
	elif meters.get("Hydration", 0.0) > 50.0 and meters.get("Calories", 0.0) > 50.0:
...
func _build_obituary(meter: String) -> String:
	var death: String = {"Blood": "blood loss", "Hydration": "dehydration", "Calories": "starvation", "Warmth": "the cold", "Energy": "sheer exhaustion", "Immune": "sickness", "Mental": "despair"}.get(meter, meter)
	var worst := ""
	var worst_stage := 0
	for id in conditions:
		var st: int = cond_stage.get(id, 0)
...
func reset() -> void:
	...
	loc_indoor = {}
	lit_sources = {}
	meters = {"Satiation": 65.0, "Calories": 82.0, "Hydration": 74.0, "Blood": 100.0, "Warmth": 55.0, "Energy": 70.0, "Sleep": 90.0, "Immune": 78.0, "Mental": 64.0}
	conditions = {}
	cond_stage = {}
	cond_prev = {}
	cond_last = {}
